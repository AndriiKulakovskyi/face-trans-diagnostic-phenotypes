...
This regenerates all 12 figures directly into `article_v2/figures/` under their
manuscript names. article_v2 is the main article and is self-contained: the wrapper
and all generators live under `article_v2/figures/scripts/`.
...
| **Fig 5** | **fig:money** | **`figures/scripts/fig5_archetype_prognosis.py`** (standalone) | fig5_archetype_prognosis.png | fig5_archetype_prognosis.png |
| Fig 6 | fig:prognosis_quant | `figures/scripts/fig6_prognosis_rebuilt.py` (treatment-free) | fig6_prognosis_rebuilt.png | fig6_prognosis_quant.png |
...
| ED E4 | edfig:loso | `figures/scripts/edfig_loso.py` | edfig_loso.png | edfig_loso.png |
