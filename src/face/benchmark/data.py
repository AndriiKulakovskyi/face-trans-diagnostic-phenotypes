...
from face.prognosis.endpoints import build_endpoints

from . import ARCH, CANON

REPO = Path(__file__).resolve().parents[3]
PROC = REPO / "data" / "processed"
COPULA_COORDS = REPO / "results" / "m2_strata" / "coordinates"
COPULA_CONSOLIDATE = REPO / "results" / "m2_strata" / "consolidate"
IPW_PATH = REPO / "results" / "m3_temporal" / "attrition" / "ipw_weights.parquet"  # M3 attrition IPW
