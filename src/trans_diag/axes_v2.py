...
**This supersedes ``axes.py`` for v2.** ``axes.py`` holds the *stale v1* 6-axis solution (depression,
later_onset, mania_activation, illness_burden, cognition_verbal, metabolic) and is kept only for the
v1 scripts (05/07) that still import it. Do NOT use ``axes.py`` for v2.
...
Import: ``from trans_diag.axes_v2 import AXIS_NAMES, AXIS_SHORT, AXIS_LABELS, ORTHOGONAL_DIMENSIONS``.
