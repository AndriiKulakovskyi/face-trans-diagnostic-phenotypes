...
> precision-psychiatry plan ([`../V3_PLAN.md`](../V3_PLAN.md) · [`../ROADMAP.md`](../ROADMAP.md) ·
> [`../PIPELINE.md`](../PIPELINE.md)). This masked pairwise-correlation → PAF → Schmid–Leiman pipeline
> is now the V3 **reproducibility baseline** (V3 plan, Phase D); its conclusions are **V3 hypotheses to
> retest, not settled facts** (see [`README.md`](README.md)).
