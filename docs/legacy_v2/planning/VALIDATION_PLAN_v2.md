...
> [`../../ROADMAP.md`](../../ROADMAP.md)). See [`../README.md`](../README.md).
...
## Data reality (inventory, `/tmp` → to promote to `scripts/08_v1v4_inventory.py`)
...
**Tests** (`scripts/09_cohort_confound.py`):
...
**Tests** (`scripts/10_orthogonality_pfactor.py`):
...
**Tests** (`scripts/11_longitudinal_coherence.py`; adapt v1 scripts 08/09):
...
## Deliverables
`scripts/08_v1v4_inventory.py` (promote the inventory) · `09_cohort_confound.py` ·
`10_orthogonality_pfactor.py` · `11_longitudinal_coherence.py` · `12_predictive_validity.py`;
