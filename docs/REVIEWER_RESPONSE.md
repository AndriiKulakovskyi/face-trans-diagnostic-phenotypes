...
| P0-06 biology-G arithmetic | **DOC** | The stale "92–98%" came from the superseded r=0.28; with r=0.06/0.14 it is 98.0–99.6%. One definitive table replaces it (`docs/BIOLOGY_G_TABLE.md`); the main manuscript already says "largely independent", not 92–98%. |
