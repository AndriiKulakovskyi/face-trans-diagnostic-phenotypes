...
(e.g. the planned `hierarchical_fa.py` module became `masked_fa.py` + the `01–06` scripts; planned
...
- [VALIDATION_PLAN_v2.md](VALIDATION_PLAN_v2.md) — the Study A–D validation plan.
- [MANUSCRIPT_PLAN.md](MANUSCRIPT_PLAN.md) — the manuscript section/figure plan.
