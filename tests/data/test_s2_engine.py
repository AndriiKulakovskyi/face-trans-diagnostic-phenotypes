...
from face.measurement.kernel import WINDOWS, prepare  # noqa: E402
...
def test_phi_is_valid_pd_correlation_with_g_orthogonal():
    ...
    from face.measurement.kernel import S3_FACTORS, build_marginalized
...
def test_s3b_mixed_prep_selects_3cohort_nongaussian_block():
    ...
    from face.measurement.kernel import prepare_mixed
