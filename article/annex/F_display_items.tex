...
\begin{figure}[p]
  ...
  showing \emph{every} modelled indicator (all $88$ continuous and explicit items) grouped
  ...
  $=$ home-factor anchor). Three earned cross-loadings render as outlined dots in the
...
\begin{figure}[hbtp]
  ...
  immunometabolic corner (A2) carries roughly twice the resistance and side-effect burden of the
  low-burden corner (A4); stratification clears beyond confounders but individual
...
\midrule
A certified eight-dimension transdiagnostic measurement map (internal validity). &
