...
pipeline places clinical and biological measurements in one transdiagnostic coordinate
system, holds that eight-dimension map fixed, and validates it for structure, temporal
coherence and prognosis. The contribution is that validated pipeline; running through it
is one recurring empirical property---a dissociation: immunometabolic load is the domain
least entangled with overall functional severity. The cardiometabolic and inflammatory markers resolve as a single
