...
end-to-end}, so every downstream test (structure, temporal coherence, prognosis, treatment
bounds) operates on posterior coordinates rather than point scores; and the map is \emph{fixed
...
recurs across all five stages is the existence proof that this discipline reveals structure a
...
treatment-moderation analyses \citep{reise2012bifactor,asparouhov2009esem,muthen2012bayesian}. The contribution is the measurement model---its specification and validation
