...
The FACE database is the property of Fondation FondaMental; per-patient cohort data
...
dictionary, and configuration files are available at \todo{repository URL / DOI}.
...
\todo{Complete per ICMJE / journal policy and FACE--FondaMental authorship
conventions, including cohort investigators.}

\section*{Funding}
\todo{Fondation FondaMental and cohort funders to be specified.}

\section*{Competing interests}
\todo{Declare per journal policy.}

\section*{Acknowledgements}
We thank the FACE--FondaMental Expert Centre network, participating clinicians and,
above all, the participants. \todo{Complete.}
