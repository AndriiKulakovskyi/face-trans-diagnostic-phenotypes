...
severity-independent signal a biology-aware stratification can exploit.
\end{keyresult}
...
table. Together they are the map every later chapter reads from --- a place to put any patient, and a calibrated
statement of how sure that placement is. The next chapter asks the obvious question of any such map: do its
positions cluster into \emph{types}, or is it a continuum?
