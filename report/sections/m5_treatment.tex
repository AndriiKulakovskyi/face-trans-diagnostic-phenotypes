...
residual confounding after weighting.}
\label{tab:m5overlap}
...
metabolic/inflammatory $\times$ functioning interaction whose interval excludes zero (ATE $-0.231$, E-value
...
metabolic/inflammatory $\times$ functioning interaction excludes zero (ATE $-0.231$, E-value $1.77$), but the
...
cleanest contrast (lithium) is a well-identified null, the antipsychotic metabolic/inflammatory signal is
...
null where it counts, a testable hypothesis (metabolic/inflammatory $\times$ antipsychotic functioning), a
