...
spine moves markedly more often than the biology corner ($34.5\%$ vs $20.2\%$); the ``slide on severity, keep the
phenotype'' pattern outnumbers its converse by $2.2\times$ ($25.8\%$ vs $11.5\%$).}
