...
The headline of the measurement map --- that metabolic and inflammatory load are nearly orthogonal to the
general functional-burden factor ($\phi_{Gd}\approx 0.14$ and $0.06$; Chapter~\ref{sec:results}) --- is the
...
$\phi_{Gd}\approx 0.06$--$0.14$ values read as a \emph{quantification} of a pattern the prior literature had
