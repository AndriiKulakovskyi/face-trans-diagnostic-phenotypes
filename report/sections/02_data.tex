...
is reported as a two-cohort axis and not claimed for DR. A factor's transdiagnosticity is therefore
...
\caption{Observed coverage is structured, not random: it varies by factor block and by cohort. The
depression/anxiety windows and the mania self-report are absent in SZ (present in BP and DR); the
substance-use items are absent in DR; biology, cognition, sleep, and the ISF suicidality core are broadly
covered across all three cohorts. The observed-data likelihood turns this structure from a liability into
information.}
\label{fig:coverage}
\end{figure}
