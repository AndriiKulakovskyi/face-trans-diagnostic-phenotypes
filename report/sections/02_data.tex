...
\]
fit on the \emph{full} sample with no completeness selection (Section~\ref{sec:estimation} explains why this is
...
\emph{adjudicated and flagged}, never assumed.

\begin{caveatbox}
The DR cohort ($N=552$) is small and lacks several instruments (e.g.\ FAST, QIDS, MADRS). Factors whose anchors
are cohort-specific are tested for measurement invariance (Section~\ref{sec:validation}) and their per-patient
