...
(empirical) atlas is shown beside this prior map in Section~\ref{sec:results}
(Figures~\ref{fig:priorposterior}--\ref{fig:empatlas}); their comparison is the M1 deliverable.
...
\textbf{Stratification (M2).} ARI adjusted Rand index; $\eta^2$ variance explained; Cram\'er's $V$ nominal
