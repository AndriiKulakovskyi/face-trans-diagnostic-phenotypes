...
partition of a structureless Gaussian blob (silhouette $0.140$ vs.\ $0.141\pm0.002$, $z=-0.36$). Five further
...
overwhelmingly other symptom-driven patients. Position $+$ neighbours is the continuum-native decision object;
...
evidence is flat across $K$ (XD-BIC $197{,}918$--$199{,}545$, $<1\%$). Second, the partition splits the cloud
...
tests. And it is a \textbf{tighter description of the data than diagnosis} --- a free four-region mixture beats a
...
vs DSM-5 (BIC) & free $K{=}4$ \textbf{197{,}963} vs DSM-5 7-group $201{,}294$ & tighter, fewer groups\\
